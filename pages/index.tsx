    ...
    <>
      ...
      <main className={textFont.className}>
        ...
        <section className={styles.holding}>
          ...
          <div className={styles.right}>
            ...
            <Trans
              ...
              components={{
                root: <div className={styles.description} />,
        ...
        <section className={styles.aboutUs}>
          <h2 className={classNames(styles.title, pageTitleFont.className)}>{t('aboutUsTitle')}</h2>
        ...
        <section className={styles.status}>
          <h2 className={classNames(styles.title, pageTitleFont.className)}>{t('statusTitle')}</h2>
        ...
        <section className={styles.cooperation}>
          <h2 className={classNames(styles.title, pageTitleFont.className)}>{t('cooperationTitle')}</h2>
